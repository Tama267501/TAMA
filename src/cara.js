...
➸ *${prefix}ttp*
Text to sticker contoh : ${prefix}ttp Tama
➸ *${prefix}tts*
Suara google contoh : ${prefix}tts id Hallo Tama
➸ *${prefix}toimg*
Reply sticker yang mau dijadiin image
➸ *${prefix}nulis*
Untuk menulis dibuku
➸ *${prefix}stalkig*
Stalking instagram contoh : ${prefix}stalkig tamaaa.fx
➸ *${prefix}quotes*
Random quotes
➸ *${prefix}bikinquote*
Membuat quotes contoh : ${prefix}bikinquote Kamu gay & Tama
➸ *${prefix}play*
...
➸ *${prefix}hartatahta*
Membuat lomgo, contoh : ${prefix}hartatahta Pratama
➸ *${prefix}pornhub*
Membuat logo, contoh : ${prefix}pornhub TAMA & Hub
